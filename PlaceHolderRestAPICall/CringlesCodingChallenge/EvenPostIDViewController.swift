//
//  EvenPostIDViewController.swift
...
class EvenPostIDViewController: CommentsCommonViewController {
    ...
    override func prepare(ForCommentList list: [Comment]) {
        ...
        // filter it as even postID only
        self.commentList = list.filter({ $0.postID % 2 == 0 })
    }
